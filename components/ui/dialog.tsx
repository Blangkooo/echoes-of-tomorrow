  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-[#171717] border border-white/8 rounded-2xl shadow-2xl",
        "p-6 gap-4",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 text-[#A3A3A3] hover:text-[#FAFAFA] hover:bg-white/6 transition-colors">
        <X className="h-4 w-4" />
